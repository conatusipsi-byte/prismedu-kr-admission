  ...
  ({ className, type, size = "default", error, ...props }, ref) => {
    return (
      <input
        ...
        className={cn(
          // Base — radius 12px (spec) + brand 2px focus border + soft ring halo
          "flex w-full rounded-xl border border-input bg-background px-3.5 py-2 ring-offset-background",
